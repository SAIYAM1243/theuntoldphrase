...
export const posts = [
  {
    ...
    desc:
      ...
      '<p>“The Untold Phrase” is a platform for budding writers to showcase their original work and get exposure.We appreciate real talents in every possible way.Here people can find wonderful writings be it micro tales, poetries or stories.</p>import Markdown from \'markdown-to-jsx\';\n' +
    ...
    user: {
      ...
      name: "The UntoldPhrase",
      image:
        "https://www.theuntoldphrase.com/wp-content/uploads/2022/10/Copy-of-tup1-50x50.png",
    },
