...
import { useVerification } from "../hooks/auth-hooks";
import { useResend } from "../hooks/auth-hooks";
...
const OTPVerification = () => {
  ...
  return (
    <div className={clsx(
      ...
      theme ? "bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-[#302943] via-slate-900 to-black" :
        "bg-gray-200"
    )}
    >
      <Paper
      ...
      >
        <div className="flex flex-col items-center justify-center mb-6">
          ...
          >
            Please enter the OTP code sent to your mail.
          </span>
        </div>
        <PinInput
          oneTimeCode
