  ...
  return (
    <Tooltip label={label} position="right" transitionProps={{ duration: 0 }}>
      <UnstyledButton onClick={onClick}
        className={clsx(
          "flex items-center gap-2 px-4 py-3 rounded-full", active ? "bg-black text-white" : ""
        )}

        data-active={active || undefined}
      >
        <Icon
          style={{ width: rem(20), heigth: rem(20) }} stroke={1.5}
        />
        {label}
      </UnstyledButton>
    </Tooltip>
...
const Sidebar = ({ close = () => { } }) => {
  ...
  return (
    <nav className=" flex flex-col gap-5 mt-10  border-slate-700 px-6 2xl:px-14">
      {/* <p className="py-2">
        Menu
      </p> */}
      ...
      <ActionIcon
        ...
        className="w-full rounded-full mt-auto mb-6"
      >
        {
